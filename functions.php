...
function wordflat_scripts() {
    ...
    wp_enqueue_script( 'FitText', 'http:////cdnjs.cloudflare.com/ajax/libs/FitText.js/1.2.0/jquery.fittext.js' );

    wp_enqueue_script( 'wordflat-script', get_template_directory_uri() . '/assets/scripts.min.js' );
